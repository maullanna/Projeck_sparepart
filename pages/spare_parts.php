          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td class="text-center">
                    <div class="btn-group" role="group" aria-label="Actions">
                      <a type="button" class="btn btn-sm btn-primary" href="pro_edit.php?action=edit&id=' . $row['PRODUCT_ID'] . '">
                        <i class="fas fa-edit"></i> Edit
                      </a>
                      <a type="button" class="btn btn-sm btn-danger ml-2" href="pro_del.php?action=del&id=' . $row['PRODUCT_ID'] . '">
